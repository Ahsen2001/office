...
@section('content')
    <div class="d-flex flex-column flex-xl-row justify-content-between gap-3 mb-4">
        ...
        <a href="{{ route('staff.applications.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus me-1"></i> Create Application</a>
    </div>

    <div class="card soft-card">
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                <thead class="table-light"><tr><th>No</th><th>Person</th><th>Service</th><th>Department</th><th>Status</th><th>Priority</th><th class="text-end">Actions</th></tr></thead>
                <tbody>
                    @forelse($applications as $application)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('staff.applications.show', $application) }}" class="btn btn-sm btn-outline-primary">View</a>
